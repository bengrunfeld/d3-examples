...
let padding = 5
let dimensions = {chartWidth: 0, chartHeight: 200, barWidth: 10, barHeight: 0}
...
svg.append('g')
  .call(xAxis)
  .attr('transform', `translate(${margin.left}, ${dimensions.chartHeight + padding})`)
...
svg.append('g')
  ...
  .selectAll('rect').data(dataArr).enter().append('rect')
    ...
    .attr('height', (d, i) => (d.c > d.o) ? (d.c - d.o) : (d.o - d.c))
